  ...
  return (
    <section className='flex font-outfit'>
        ...
        <Link to="/welcome" className='flex items-center justify-center flex-col gap-[1.35rem] mt-[3.3rem] mb-0'>
          ...
          <h5 className='text-center text-[0.88rem] lg:text-lg font-normal leading-normal text-[#1C1D24]'>Your CVs will appear here once you create them. <br /> Get started and build a CV that stands out.</h5>
        </Link>
