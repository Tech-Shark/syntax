...
const Achievement: React.FC = () => {
    ...
    // // Autopopulate the form with achievements from Redux
    // useEffect(() => {
    //     if (achievements) {
    //         setAwardsList(achievements.award);
    //         setCertificationsList(achievements.certification);
    //         setAcademicHonorsList(achievements.academicHonor);
    //         setMilestonesList(achievements.milestone);
    //     }
    // }, [achievements]);
