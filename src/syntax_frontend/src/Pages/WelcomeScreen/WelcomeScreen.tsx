...
const WelcomeScreen: React.FC = () => {
  return (
    <>
      <section className="">
        <WelcomeHeader>
           <div className="flex justify-center items-center flex-col h-auto w-full pt-24 md:pt-20 pb-10 pl-3.5 gap-[6.25rem] ">
          ...
          <div className="flex flex-col gap-5 items-center justify-center">
            <Link to="/auth-welcome" className="flex items-center justify-center gap-2 py-[0.41rem] px-[1.03rem] bg-[#000006] rounded-3xl">
            ...
            <Link to="/auth-welcome" className="flex items-center justify-center gap-2 self-stretch rounded-[1.8rem] py-[0.65rem] px-5 bg-white [box-shadow:-2px_-4px_25.7px_0_rgba(0,0,0,0.1),_2px_4px_28.7px_0_rgba(0,0,0,0.1)] hover:gap-8 transition-all duration-300">
