...
const SavedInfo: React.FC = () => {
    ...
    return (
        <section>
            <WelcomeHeader leftLabel="Edit my Info" leftLink="/edit-cv" rightLabel="View Templates"
                           rightLink="/templates">
                <div
                    className="flex justify-center items-center flex-col h-auto w-full pt-32 pr-[0.8125rem] pb-10 pl-3.5 gap-[6.25rem]">
                    ...
                    <div className="flex flex-col gap-5 items-center">
                        <Link to="/job_description"
                            ...
                            <p className="text-white text-center font-semibold leading-7 text-[0.928rem]">Start
                                Applying</p>
                        ...
                        <Link to="/user-dashboard"
                            ...
                            <p className="text-[#3D3F4E] text-center text-lg font-semibold leading-8">Go to
                                Dashboard</p>
                            <div
