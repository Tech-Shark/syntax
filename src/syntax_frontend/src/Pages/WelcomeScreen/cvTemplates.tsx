  ...
  return (
    <section className='flex font-outfit'>
        ...
        <nav className='md:hidden flex justify-between items-center '>
          ...
          >
            <div className='flex items-center justify-center bg-[#d2d2d2] w-8 h-8 rounded-full shadow-[0.67px_0.67px_13.28px_rgba(61,63,78,0.5)]'><img src={backwardsArrow} alt="Go Back"/></div>
        ...
        <div className="flex items-center justify-center bg-[#3D3F4E] w-8 h-8 rounded-full shadow-[0.67px_0.67px_13.28px_rgba(61,63,78,0.5)] cursor-pointer">
          ...
          <div className='mt-6 md:mt-0 flex justify-center md:justify-between w-full '>
            <h5 className='font-bold text-[2.5rem] text-center md:text-left sm:text-3xl lg:text-[3rem]  md:leading-[4rem]'>Choose the Perfect Template</h5>
            <TopIcons />
          </div>

          <div className='flex gap-4 mt-1 md:mt-8 font-semibold text-[0.93rem] leading-[1.73rem] flex-wrap justify-center md:justify-start'>
           <p className='color-black text-center text-[0.88rem] md:text-left md:text-base font-normal leading-normal'>Pick a template that suits your style, or explore tailored <br className='lg:hidden'/> recommendations <br className='hidden md:block'/> based on your career goals.</p>
          </div>


        <div className="flex justify-between my-8 flex-col">
          <div className='flex md:hidden justify-between items-center gap-2 border-black border-2 rounded-[2.25rem] px-[1.3rem] md:px-[1.88rem] py-[0.94rem]'>
            <input type="text" className='outline-none placeholder-shown:opacity-[0.4] text-black text-[1.1rem] md:text-[1.2rem] font-normal leading-normal' placeholder='Search Templates'/>
          ...
          <div className='flex justify-between items-center my-14 md:my-[5rem] md:gap-20'>
            <Collapsible>
            <CollapsibleTrigger className='flex items-center gap-2  font-semibold text-base leading-normal lg:text-[1.34rem] lg:leading-[1.68rem]'>Recommended Templates 
          ...
          <div className='hidden md:flex items-center gap-2 border-black border-2 rounded-[2.25rem] px-[1.88rem] py-[0.94rem]'>
