...
function Template7({cvData}: {cvData : Record<string, any>}) {
  ...
  return (
    <div className="min-h-screen bg-gray-600 p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg">
        {/* Header */}
        <div className="bg-[#323B4C] text-white py-6 sm:py-8 px-4 sm:px-8 md:px-12">
          <div className="flex flex-col items-start sm:items-end">
            <h1 className="text-2xl sm:text-3xl font-bold mb-1 break-words max-w-full">
