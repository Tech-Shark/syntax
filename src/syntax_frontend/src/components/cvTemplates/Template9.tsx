...
function Template9({cvData}: {cvData : Record<string, any>}) {
            ...
            <section>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <GiRotaryPhone className="w-4 h-4 sm:w-5 sm:h-5 text-[#916264] shrink-0 mt-0.5" />
                  <span className="text-sm break-words">{mockData.contact.phone}</span>
                </div>
                <div className="flex items-start gap-3">
                  <IoMailSharp className="w-4 h-4 sm:w-5 sm:h-5 text-[#916264] shrink-0 mt-0.5" />
                  <span className="text-sm break-words">{mockData.contact.email}</span>
                </div>
                <div className="flex items-start gap-3">
                  <CiLocationOn className="w-4 h-4 sm:w-5 sm:h-5 text-[#916264] shrink-0 mt-0.5" />
