...
// {cvData}: {cvData : Record<string, any>}
function Template11({cvData}: {cvData : Record<string, any>}) {
    ...
    <div className="min-h-screen bg-gray-600 p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row justify-between mb-4">
          <div className="bg-[#2D3748] w-full sm:w-[33.5%] h-32 sm:h-44 rounded-br-[30px] sm:rounded-br-[50px]"></div>
          <div className="flex flex-col w-full sm:w-[64%] justify-center p-4 sm:p-0">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2D3748] mb-1 break-words">
              {mockData.firstName} {mockData.lastName}
            </h1>
            <p className="text-[#2D3748] uppercase tracking-wide text-lg sm:text-xl">
              {mockData.title}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center px-4 sm:px-0">
          <div className="bg-[#374151] text-white rounded-2xl sm:rounded-3xl py-2 sm:py-3 px-4 sm:px-8 flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm w-full max-w-3xl">
            <div className="flex items-center gap-2">
              <GiRotaryPhone className="shrink-0" />
              <span className="break-words">{mockData.contact.phone}</span>
            </div>
            <div className="flex items-center gap-2">
              <IoMailSharp className="shrink-0" />
