...
function Header() {
  ...
  return (
    ...
    <nav className='flex items-center w-4/5 sm:w-auto rounded-full border px-4 lg:px-[1.25rem] py-[0.5rem] '>
        <Link to='/'>
        <img src={logo} alt="logo icon" className='w-8 lg:w-[3.75rem] h-8 lg:h-[3.75rem]  cursor-pointer mr-4 lg:mr-8' />
        </Link>
